...
public final class panel_Alta extends javax.swing.JPanel {
    ...
    public void validar() {
        ...
        Combo_Año_Nacimiento.setSelectedIndex(0);
        Combo_Dia_Nacimiento.setSelectedIndex(0);
        Combo_Mes_Nacimiento.setSelectedIndex(0);
        //lblInformacionContraseña.setText("");
        lblCantidadCaracteres.setText("");
        lblBusquedaDni.setText("");
    }
