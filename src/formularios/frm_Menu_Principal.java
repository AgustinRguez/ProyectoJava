...
public final class frm_Menu_Principal extends javax.swing.JFrame {
    ...
    public void salir(){
        ...
        int i=JOptionPane.showConfirmDialog(null, "Cerrar sesion? ","Cerrar sesion", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        if(i == 0){
    ...
    private void initComponents() {
        ...
        lblNombreSesion.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
    ...
    private void boton_ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_ModificarActionPerformed
        if(boton_Modificar.isSelected())
        {
            ...
            panelModificacion.borrarDatos();
            panelModificacion.borrarDos();
        }
        else
        {
    ...
    private void boton_BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_BuscarActionPerformed
        if(boton_Buscar.isSelected())
        {
            ...
            panelBuscar.tabla.fireTableDataChanged();
            panelBuscar.cargarDatosEnLaTabla();
            panelBuscar.txtIngresarDniBusqueda.setText("");
        }
        else
        {
            panel_Vista_Principal.removeAll();
    ...
    private void boton_BajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_BajaActionPerformed
        if(boton_Baja.isSelected())
        {
            ...
            panelBaja.borrarDatosConDniIncluido();
            panelBaja.limpiarCaja();
        }
        else
        {
            panel_Vista_Principal.removeAll();
